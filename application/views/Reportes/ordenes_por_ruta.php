                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title uppercase"><label for=""><strong>SELECCIONE LA RUTA</strong></label></h3>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" method="post" target="_blank" action="<?= base_url(); ?>Reportes/pivote_ordenes_ruta" novalidate>
                                    <div class="form-row">

                                        <div class="col-xl-3 mb-6">
                                            <label for="rutaReporte"><strong>Bodega destino</strong></label>
                                            <select class="form-control" id="rutaReporte" name="rutaReporte" required>
