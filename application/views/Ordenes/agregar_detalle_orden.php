                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12 alert-info p-6">
                                    ...
                                    <table class="table table-borderless mt-3">
                                        ...
                                        <tr>
                                            <td class="text-black"><strong>Dirección de entrega: </strong></td>
                                            <td colspan="3">
                                                <?php 
                            ...
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <hr>
                                    <form class="needs-validation" method="post" action="<?= base_url(); ?>Ordenes/guardar_detalle_orden" novalidate>
                                        <table class="table table-borderles">
                                            <tr>
                                                <td style="width: 200px;"><strong>Contenido del paquete: </strong></td>
                                                <td><textarea class="form-control" name="contenidoPaquete" id="contenidoPaquete" rows="5" required=""></textarea></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <!-- input-group-text -->
                                                        <input class="form-control" type="text" name="pesoPaquete" id="pesoPaquete" placeholder="Peso en libras" required="">
                                                        <div class="invalid-tooltip">Este campo es obligatorio</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <!-- input-group-text -->
                                                        <input class="form-control" type="text" name="precioPaquete" id="precioPaquete" placeholder="Precio por lb" required="">
                                                        <div class="invalid-tooltip">Este campo es obligatorio</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <!-- input-group-text -->
                                                        <input class="form-control" type="text" value="0" name="declaradoPaquete" id="declaradoPaquete" placeholder="Precio por lb" required="">
                                                        <div class="invalid-tooltip">Este campo es obligatorio</div>
                                                    </div>
                                                </td>
                                            </tr>
