                    ...
                    <div class="page-header">
                        <div>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gestión de accesos de usuario</li>
                            </ol>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <table class="table table-bordered text-nowrap border-bottom basic-datatable" id="">
                                        <thead>
                                            <tr class="bg-primary">
                                                <th class="border-bottom-0 text-white" scope="col">#</th>
                                                <th class="border-bottom-0 text-white" scope="col">Nombre acceso</th>
                                                <th class="border-bottom-0 text-white" scope="col">Descripción</th>
                                                <th class="border-bottom-0 text-white" scope="col">Opción</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                        ...
                                                        echo "<a onclick='actualizarAcceso($id, $nombre, $descripcion)' href='#actualizarAcceso' data-bs-toggle='modal'><i class='fa fa-edit ms-text-success iconoPlus'></i></a> ";
                                                        echo "<a onclick='eliminarAcceso($id)' href='#eliminarAcceso' data-bs-toggle='modal'><i class='fa fa-trash text-danger iconoPlus'></i></a> ";
                                                    ?>
                                                </td>
                                            </tr>
                                            <?php  }  ?>
